...
Mit der Installation der Zotero Desktop Applikation solle parallel das
...
* Add/Edit Citation.
  ...
  (shortend notes and bibliography)' ausgewählt. Die Wahl des Stils ist
  ...
  ![Suche nach Referenzen, die den Namen Müller
   ...
   ausgewählt werden.](praezisierung.png)
...
* 'Insert Note'.
  ...
  In Zotero können Notizen angelegt werden (vgl. XXX). Mit 'Insert Note'
  kann nach Notizen gesucht und diese in den Text eingefügt werden.
...
Snap Shot der Website gespeichert. Der Inhalt der Referenz kann nicht
...
gespeichert. 
Ausserdem können auch eigenständige Notizen angelegt werden. Dazu kann
